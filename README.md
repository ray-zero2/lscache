lscache
===============================
**Update**: The library has been modified to prevent automatic deletion of expired storage on get execution. If deletion is necessary, execute flushExpired before performing the get operation.
